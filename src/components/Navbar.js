...
import { Menu, X } from "lucide-react"; // if not installed, replace with "☰" and "✖"
...
function Navbar() {
  ...
  <button
    ...
    className="bg-purple-700 text-white px-3 py-2 rounded-md hover:bg-purple-900 transition"
  >
    {open ? <X className="w-6 h-6" /> : <Menu className="w-6 h-6" />}
      ...
      <div
        ...
        } transition-transform duration-300 z-40 pt-20`}
      >
